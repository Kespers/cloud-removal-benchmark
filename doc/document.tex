...
\input{parts/0_frontespizio.tex} %<- richiama il file "parts/titlepage.tex" che contiene il frontespizio
...
\input{parts/4_dataset.tex}
\input{parts/5_experiments.tex}
\input{parts/6_results.tex}
\input{parts/7_conclusions.tex}
